...
class Timesheet extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Security\UserLogin', 'approved_by_user_login_id', 'user_login_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Party', 'client_party_id', 'party_id');
    }
