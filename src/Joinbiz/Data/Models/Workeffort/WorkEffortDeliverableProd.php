 ...
 */
class WorkEffortDeliverableProd extends Model
{
     ...
     * @var string
     */
    protected $table = 'work_effort_deliverable_prod';
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\Deliverable', 'deliverable_id', 'deliverable_id');
    }
