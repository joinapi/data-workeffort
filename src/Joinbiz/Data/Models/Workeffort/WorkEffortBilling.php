 ...
 */
class WorkEffortBilling extends Model
{
     ...
     * @var string
     */
    protected $table = 'work_effort_billing';

    /**
     * @var array
     */
    protected $fillable = ['percentage', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
