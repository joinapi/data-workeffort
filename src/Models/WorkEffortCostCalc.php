...
class WorkEffortCostCalc extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\CostComponentCalc', 'cost_component_calc_id', 'cost_component_calc_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\CostComponentType', 'cost_component_type_id', 'cost_component_type_id');
    }
