 ...
 */
class WorkEffortIcalData extends Model
{
     ...
     * @var string
     */
    protected $table = 'work_effort_ical_data';
     ...
     * @var array
     */
    protected $fillable = ['ical_data', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
