 ...
 */
class CommunicationEventWorkEff extends Model
{
     ...
     * @var string
     */
    protected $table = 'communication_event_work_eff';
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\CommunicationEvent', 'communication_event_id', 'communication_event_id');
    }
