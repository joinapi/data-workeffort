...
class WorkEffortPartyAssignment extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\UserLogin', 'assigned_by_user_login_id', 'user_login_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\Enumeration', 'delegate_reason_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\Enumeration', 'expectation_enum_id', 'enum_id');
    }
